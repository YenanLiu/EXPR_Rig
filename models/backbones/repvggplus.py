...
def create_RepVGGplus_L2pse(num_classes=139, deploy=False, use_checkpoint=False):
...
#   Will release more
repvggplus_func_dict = {'RepVGGplus-L2pse': create_RepVGGplus_L2pse,}

def create_RepVGGplus_by_name(name, num_classes, deploy=False, use_checkpoint=False):
    if 'plus' in name:
        return repvggplus_func_dict[name](num_classes, deploy=deploy, use_checkpoint=use_checkpoint)
    else:
